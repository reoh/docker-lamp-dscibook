...
<div class="container">
    ...
    <form id="fileupload" action="server/php/adminFileUploadHandler.php" method="POST" enctype="multipart/form-data">
...
<script src="js/main_adminFileupload.js"></script>
