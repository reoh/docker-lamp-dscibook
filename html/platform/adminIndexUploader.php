...
<div class="container">
    ...
    <form id="fileupload" action="server/php/adminIndexUploadHandler.php" method="POST" enctype="multipart/form-data">
...
<script src="js/main_adminIndexupload.js"></script>
